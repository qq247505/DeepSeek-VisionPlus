import { n as __esmMin } from "./rolldown-runtime-CNf5ZN-e.mjs";
import { c as init_fetch_blob, i as init_esm_min, n as FormData, r as formDataToBlob, s as Blob, t as init_from } from "./from-C9p_wOgV.mjs";
	...
	Body = class {
		...
		*/
		...
		async formData() {
			...
			const { toFormData } = await import("./multipart-parser-OozLCVYw.mjs");
